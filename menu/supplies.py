            ...
            with st.expander('Distorções (Valor da Despesa - Valor dos Insumos)', expanded=True):
                ...
                if bluemeWithOrder.empty:
                    ...
                    with col1:
                        ...
                        component_plotDataframe_aggrid(bluemeWithOrder, 'Detalhamento das Distorções', df_details=assocExpenseItems, coluns_merge_details='ID_Despesa', coluns_name_details='Casa' ,key="grid_distorcoes")
